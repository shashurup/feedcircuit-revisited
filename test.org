...
[[#:feed{:url "http://www.opennet.ru/opennews/opennews_all.rss",
 ...
 [#:feed{:url "https://lenta.ru/rss",
         :content-ident [:class "topic-body__content"]}]
 ...
 [#:feed{:url "https://kiwibyrd.org/feed/",
         :content-ident [:class "entry-content"]}]
